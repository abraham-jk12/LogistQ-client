  ...
  return (
    <div className="p-6 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-green-700 text-white p-4 rounded-lg shadow-md flex flex-col items-center justify-center">
        ...
        <div className="bg-green-400 text-white p-4 rounded-lg shadow-md flex flex-col items-center justify-center">
