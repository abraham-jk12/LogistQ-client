        ...
        <table className="min-w-full table-auto">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-4 py-2 text-left text-gray-600 font-semibold">Supplier</th>
              <th className="px-4 py-2 text-left text-gray-600 font-semibold">Price</th>
              <th className="px-4 py-2 text-left text-gray-600 font-semibold">Stock</th>
